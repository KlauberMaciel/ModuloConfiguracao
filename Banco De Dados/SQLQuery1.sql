USE [master]
GO
/****** Object:  Database [Configuracao]    Script Date: 16/03/2023 13:58:35 ******/
...
USE [Configuracao]
GO
/****** Object:  Table [dbo].[GrupoUsuario]    Script Date: 16/03/2023 13:58:35 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Permissao]    Script Date: 16/03/2023 13:58:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Permissao_GrupoUsuario]    Script Date: 16/03/2023 13:58:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Permissao_GrupoUsuario](
	[IdPermisao] [int] NOT NULL,
	[IdGrupoUsuario] [int] NOT NULL,
 CONSTRAINT [PK_Permissao_GrupoUsuario] PRIMARY KEY CLUSTERED 
(
	[IdPermisao] ASC,
	[IdGrupoUsuario] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 16/03/2023 13:58:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario_GrupoUsuario]    Script Date: 16/03/2023 13:58:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Permissao_GrupoUsuario]  WITH CHECK ADD  CONSTRAINT [FK_Permissao_GrupoUsuario_GrupoUsuario] FOREIGN KEY([IdGrupoUsuario])
REFERENCES [dbo].[GrupoUsuario] ([Id])
GO
ALTER TABLE [dbo].[Permissao_GrupoUsuario] CHECK CONSTRAINT [FK_Permissao_GrupoUsuario_GrupoUsuario]
GO
ALTER TABLE [dbo].[Permissao_GrupoUsuario]  WITH CHECK ADD  CONSTRAINT [FK_Permissao_GrupoUsuario_Permissao] FOREIGN KEY([IdPermisao])
REFERENCES [dbo].[Permissao] ([Id])
GO
ALTER TABLE [dbo].[Permissao_GrupoUsuario] CHECK CONSTRAINT [FK_Permissao_GrupoUsuario_Permissao]
GO
ALTER TABLE [dbo].[Usuario_GrupoUsuario]  WITH CHECK ADD  CONSTRAINT [FK_Usuario_GrupoUsuario_GrupoUsuario] FOREIGN KEY([IdGrupoUsuario])
REFERENCES [dbo].[GrupoUsuario] ([Id])
GO
ALTER TABLE [dbo].[Usuario_GrupoUsuario] CHECK CONSTRAINT [FK_Usuario_GrupoUsuario_GrupoUsuario]
GO
ALTER TABLE [dbo].[Usuario_GrupoUsuario]  WITH CHECK ADD  CONSTRAINT [FK_Usuario_GrupoUsuario_Usuario] FOREIGN KEY([IdUsuario])
